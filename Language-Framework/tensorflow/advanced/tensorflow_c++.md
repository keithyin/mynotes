...
> 使用tensorflow 的 python接口进行训练，然后用c++代码进行部署，感觉这样的配合才合理嘛，但是网上关于tensorflow c++ 部分的代码很少，这里就拿着官网的示例强行解释一波了。[源码地址](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/examples/label_image/main.cc) [官方教程](https://www.tensorflow.org/tutorials/image_recognition)
