...
// Variable 的标记： requires_grad, is_volatile, 
struct VarFlags {
...
// Variable 是 Tensor 的一个 子类，C++ 中，这个和 Python 中还是不一样的。
...
public:
  ...
  // VariableImpl 中有数据，有梯度， 有 _grad_fn， 有 grad_accumulator
  at::Tensor data;
  Variable grad;
